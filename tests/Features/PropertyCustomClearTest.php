...
test('HasOneOrMany property custom clear test', function () {
...
test('BelongsToMany property custom clear test', function () {
    $user = UserPropertyCustom::inRandomOrder()->first();
    $userId = $user->id;
    $roles = $user->roles;
